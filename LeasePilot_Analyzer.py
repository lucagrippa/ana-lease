    ...
    if st.session_state["lease_uploaded"] is False:
        ...
        if uploaded and uploaded_file is not None:
            with st.spinner("Uploading your lease..."):
                ...
                print("Store chunks and pages into session state")
                st.session_state["chunks"] = chunks
                st.session_state["pages"] = pages
                print("Create a store chat memory for this lease")
                memory = ConversationBufferMemory(memory_key="chat_history", return_messages=True)
                st.session_state["memory"] = memory

            print("Set lease uploaded to True")
        ...
        with st.spinner("Analyzing your lease..."):
            ...
            print("Set lease analyzed to True")
